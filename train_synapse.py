...
if __name__ == "__main__":
    ...
    snapshot_path = "model_pth_MERIT_bs8/{}/{}".format(args.exp, 'MERIT_Cascaded_Small_loss_MUTATION_w3_7')
    ...
    net = MERIT_GLAG_Cascaded(n_class=args.num_classes, img_size_s1=(args.img_size,args.img_size), img_size_s2=(224,224), model_scale='small', decoder_aggregation='additive', interpolation='bilinear')
    # net = PvtGraphNet(n_class=args.num_classes).cuda()
