...
if __name__ == "__main__":
    ...
    snapshot_path = "./model_pth_MERIT_bs8_3/{}/{}".format(args.exp, 'MERIT_Cascaded_Small_loss_MUTATION_w3_7')
    ...
    net = MERIT_GLAG_Cascaded(n_class=args.num_classes, img_size_s1=(args.img_size,args.img_size), img_size_s2=(224,224), model_scale='small', interpolation='bilinear').cuda()
    ...
    log_folder = 'test_MERIT-GCASCADE-bs8-3_synapse_log/test_MERIT-GCASCADE_synapse_log_' + args.exp
    ...
    if args.is_savenii:
        ...
        test_save_path = '/root/autodl-tmp/project3/MERIT-main/pred-MERIT-GCASCADE-bs8-3'
